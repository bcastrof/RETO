...
DROP
 ...
 --creacion y restricción de tablas 
  ...
  (
	...
	LEYIDO VARCHAR2(10) DEFAULT 'NO' CONSTRAINT AVS_LEY_CHK CHECK (LEYIDO IN('NO','SI'))
  ) ;
...
CREATE
  ...
  (
    ID          NUMBER (7),
    horaInicial varchar2 (5) DEFAULT '00:00' NOT NULL ,
    horaFinal   varchar2 (5) DEFAULT '00:00' NOT NULL,
    TRABAJADORES_ID  NUMBER (7) NOT NULL,
	FECHA_ID varchar2(10) 
  ) ;
ALTER TABLE VIAJES ADD CONSTRAINT VIAJES_PK PRIMARY KEY (horaInicial, TRABAJADORES_ID, FECHA_ID  ) ;
...
CREATE SEQUENCE  "LOGISTICA"."SQAVISOS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCYCLE;
CREATE SEQUENCE  "LOGISTICA"."SQCENTROS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCYCLE;
CREATE SEQUENCE  "LOGISTICA"."SQTRABAJADORES"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCYCLE ;
CREATE SEQUENCE  "LOGISTICA"."SQVEHICULOS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCYCLE ;
CREATE SEQUENCE  "LOGISTICA"."SQVIAJES"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCYCLE;